...
// remote control for LK8000, emulates a keyboard
...
//  I/O Button      key first press   second    third   fourth press, keylongPress  // Symbol
  { 38, TOP_CENTER, 'X',              0,        0,      0,            '1' },      // bottom info right / custom 1
  { 10, RH_MIDDLE,  'A',              0,        0,      0,            '2' },      // alternates        / custom 2
  { 12, RH_LOWER,   KEY_ESC,          0,        0,      0,            '3' },      // menu / escape     / custom 3
  { 37, STF,        'S',              'V',      0,      0,            0 },
  ...
  { 0, JOY_PRESS,   KEY_RETURN,       0,        0,      0,            '4' }       // enter       / custom 4
};
